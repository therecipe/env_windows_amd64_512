...
for v in qtenv2.bat windeployqt.exe lconvert.exe moc.exe qmake.exe qmlimportscanner.exe qt.conf rcc.exe uic.exe *.dll; do
...
echo "module github.com/therecipe/env_windows_amd64_512/Tools" > ./Tools/go.mod
